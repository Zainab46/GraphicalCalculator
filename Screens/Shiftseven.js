...
const HandleShiftModeItems=(id,actual)=>{
 if(id=='1'){
        navigation.navigate('Main',{shiftsvn:actual});
    }
    else if(id=='2'){
        navigation.navigate('Main',{shiftsvn:actual});
    }
...
<TouchableOpacity style={styles.item} onPress={()=>{HandleShiftModeItems(item.id,item.actual)}} >
